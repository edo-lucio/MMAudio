...
time of writing is the state of the art among public V2A models on
VGGSound and surpasses earlier flow-matching V2A systems such as
Frieren \citep{wang_2024_frieren} (channel-level fusion +
reflow). MMAudio is used here purely as a substrate: it provides
a strong, well-validated pointwise-alignment baseline against
which the relational regularizer can be measured, but it is not
itself the object of study. Three of its design choices are
